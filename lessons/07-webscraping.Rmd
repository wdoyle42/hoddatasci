...
nfl_df<-nfl_df%>%slice(-1)%>%# drop first row
...
## OMDB Data
The code below first gets the titles of every Studio Ghibli movie, then searches the OMDB for these movies. It
...
# Send request for these IDs to themv_d database
mv_df <- map_df(mv$imdbID, find_by_id,include_tomatoes=TRUE)

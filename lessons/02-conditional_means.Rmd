...
We can see that graduates of private instituitions have higher debt levels than graduates of public institutions. We'll follow the same steps as we did with the unconditional mean and add the conditional mean to the dataset as a predictor.

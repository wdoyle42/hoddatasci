...
```{r}
download.file("http://www.wiley.com/legacy/wileychi/baltagi/supp/Gasoline.dat",destfile="gasoline.dat")

gas<-read_table("gasoline.dat")
...
```{r}
download.file("http://www.uta.edu/faculty/story/DataSets/NES2004.sav",
              destfile="NES2004.sav")

nes<-read_spss("NES2004.sav")
...
```{r}
psid<-read_table("http://users.nber.org/~rdehejia/data/psid_controls.txt",col_names = FALSE)

...
-   Final Project 35%: During the course of the semester you will work
    ...
    for the final project, each of which will be worth 12.5% of the
    final grade for the project. No late progress reports will be
    accepted. The final product will account for the remaining 50%. No
    late final products will be accepted.
...
Condtional Means: `02-conditional_means.Rmd`.
...
Plotting Distributions and Condtional Means: `03-plot_means.Rmd`.
...
[Reed College rvest
introduction](http://www.reed.edu/data-at-reed/resources/R/rvest.html)
...
Here)\[<http://www.aaai.org/ocs/index.php/ICWSM/ICWSM14/paper/download/8106/8101>\]

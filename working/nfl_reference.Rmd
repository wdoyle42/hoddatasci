...
## Parse web page
nfl_defense<-url %>% read_html() %>%
      html_table()
## Add names here 


##  simple, just for now
nfl_defense<-data.frame(nfl_defense[1])
names(nfl_defense)<-nfl_defense[1,]
nfl_defense<-nfl_defense%>%slice(-1)

nfl_all_stats<-left_join(nfl_df,nfl_defense)
## Win/loss record

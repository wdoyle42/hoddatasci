---
title: "Chunk Options, Naming Things"
author: "Will Doyle"
...
* split: (FALSE; logical) whether to split the output from R into separate files and include them into LaTeX by \input{} or HTML; this option only works for .Rnw, .Rtex, and .Rhtml documents (it does not work for R Markdown)

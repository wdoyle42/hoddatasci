...
first_week_days_start<-as_date("2021-01-26")

## Day for first day of the week end sequence  (eg Mon or Tues)
first_week_days_end<-as_date("2021-04-27")
...
second_week_days_start<-as_date("2021-01-28")

second_week_days_end<-as_date("2021-04-29")
...
#Start Day
hw_days_start<-as_date("2021-01-31")

#End day
hw_days_end<-as_date("2021-04-26")  
...
i<-1
```
## `r nice_date(first_week_days[i])` Topic for the Week: Getting Data-- Tools of the Trade
...
## `r nice_date(second_week_days[i])`  Getting Data: Tools of the Trade
...
## `r nice_date(first_week_days[i])` Reading Day 
...
##  `r nice_date(second_week_days[i])` Analyzing Data: Linear Regression
...
Assignment `r i-2` Due Midnight `r nice_date(hw_days[i-1])`

##  `r nice_date(second_week_days[i])` Linear Regression, continued
...
## `r nice_date(second_week_days[i])` Reading Day

Read Jill Lepore ["How the Simulmatics Corporation Invented the Future"](https://www.newyorker.com/magazine/2020/08/03/how-the-simulmatics-corporation-invented-the-future)
...
## `r nice_date(first_week_days[i])` Cross Validation, continued
...
## `r nice_date(first_week_days[i])`  Reporting Results: Using Knitr
...
Assignment `r i-3` Due Midnight `r nice_date(hw_days[i-1])`

## `r nice_date(second_week_days[i])`  Reporting Results, Continued

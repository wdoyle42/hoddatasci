...
first_week_days_start<-as_date("2018-08-28")

## Day for first day of the week end sequence  (eg Mon or Tues)
first_week_days_end<-as_date("2018-12-04")
...
second_week_days_start<-as_date("2018-08-30")

second_week_days_end<-as_date("2018-12-06")
...
#Start Day
hw_days_start<-as_date("2018-08-26")

#End day
hw_days_end<-as_date("2018-12-02")  
...
## `r nice_date(first_week_days[i])` Topic for The Week: Presenting Data 3-- Plots for Classification
...
## `r nice_date(first_week_days[i])` Topic for the Week: Training and testing multiple models, Cross Validation
...
## `r nice_date(second_week_days[i])` Thanksgiving Break

...
first_week_days_start<-as_date("2019-08-27")

## Day for first day of the week end sequence  (eg Mon or Tues)
first_week_days_end<-as_date("2019-12-03")
...
second_week_days_start<-as_date("2019-08-29")

second_week_days_end<-as_date("2019-12-05")
...
#Start Day
hw_days_start<-as_date("2019-08-25")

#End day
hw_days_end<-as_date("2019-12-01")  
...
i<-1
```
## `r nice_date(second_week_days[i]-7)` Topic for the Week: Getting Data-- Tools of the Trade
...
## `r nice_date(first_week_days[i])`  Getting Data: Tools of the Trade
...
## `r nice_date(second_week_days[i])`  Tools of the Trade, continued
...
## `r nice_date(first_week_days[i])` Analyzing Data: Conditional Means
...
Assignment `r i-1` Due Midnight, `r nice_date(hw_days[i])`
...
## `r nice_date(first_week_days[i])` Presenting Data: Descriptives
...
Wickham: [Exploratory Data Analysis](http://r4ds.had.co.nz/exploratory-data-analysis.html)
...
## `r nice_date(first_week_days[i])` Getting Data: Flat Files, Basic Concepts of "Tidy Data"
...
## `r nice_date(second_week_days[i])`  Flat Files and Tidy Data, continued
...
## `r nice_date(first_week_days[i])` Analyzing Data: Linear Regression
...
## `r nice_date(first_week_days[i])` Analyzing Data: Linear Regression, continued
...
## `r nice_date(first_week_days[i])` Presenting Data: Scatterplots
...
## `r nice_date(first_week_days[i])` Getting Data: Scraping Data from the Web, APIs
...
i<-i+1
```
## `r nice_date(first_week_days[i])`  Analyzing Data: Classification

*Resources*

James, G., Witten, D., Hastie, T., & Tibshirani, R. (2013). An introduction to statistical learning (Vol. 6). New York: Springer. [Chapter 4](http://faculty.marshall.usc.edu/gareth-james/ISL/ISLR%20Seventh%20Printing.pdf) , 
[Chapter 4 Lab R Code](http://faculty.marshall.usc.edu/gareth-james/ISL/Chapter%204%20Lab.txt)
...
## `r nice_date(second_week_days[i])` No Class, Fall Break
...
## `r nice_date(first_week_days[i])` Presenting Data: Plots for Classification
...
## `r nice_date(second_week_days[i])` Plots for Classification, continued
...
## `r nice_date(first_week_days[i])` Analyzing Data: Cross Validation
...
James, G., Witten, D., Hastie, T., & Tibshirani, R. (2013). An introduction to statistical learning (Vol. 6). New York: Springer. [Chapter 5](http://faculty.marshall.usc.edu/gareth-james/ISL/ISLR%20Seventh%20Printing.pdf) 
...
## `r nice_date(second_week_days[i])` Cross Validation, continued
...
## `r nice_date(first_week_days[i])` Getting Data: Databases and Relational Data

*Resources*
Wickham [Relational Data](http://r4ds.had.co.nz/relational-data.html)

Working with Databases in R, available: [https://dbplyr.tidyverse.org/articles/dbplyr.html](https://dbplyr.tidyverse.org/articles/dbplyr.html)
...
## `r nice_date(first_week_days[i])`  Analyzing Data: Unsupervised learning 
...
## `r nice_date(first_week_days[i])` Thanksgiving Break: No Class

Check out the lecture notes on interactive graphics,  `13-interactive_graphics.Rmd`

## `r nice_date(second_week_days[i])` Thanksgiving Break: No Class
...
Assignment `r i-3` Due Midnight `r nice_date(hw_days[i])`
